...
public class ContentProcessor {
    ...
    public void processContentSubmission(JsonObject message) {
    ...
    @Timeout(value = 15000) // 15 seconds timeout for GraphQL calls
    ...
    void updateContentSubmission(ContentSummarizationData data) {
        ...
        try {
            ...
            if (response.hasErrors()) {
                throw new RuntimeException("Failed to update content submission - GraphQL errors returned");
            }
